...
<?php 
    ...
    $query = "SELECT Pr.cant_m2,Pr.cant_dormitorios, Pr.cant_banos,Pr.precio, Pr.url_propiedad, Pr.url_foto1, Lo.nombre_localidad, Pr.descripcion FROM propiedad Pr INNER JOIN localidad Lo ON Pr.id_localidad = Lo.id_localidad WHERE Pr.id_localidad = 5 ORDER BY rand() limit 1;";
...
INNER JOIN localidad Lo ON Pr.id_localidad = Lo.id_localidad where pr.id_localidad = 5";
$result = mysqli_query($conn, $query);
