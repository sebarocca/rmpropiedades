...
<div class="vertical-nav bg-white" id="sidebar">
 ...
 ?>
  ...
  <ul class="nav flex-column bg-white mb-0">
    ...
    <li class="nav-item">
      <a href="../localidad.php" class="nav-link text-dark ">
    ...
    <li class="nav-item">
      <a href="../post.php" class="nav-link text-dark ">
...
<div class="page-content p-5" id="content">
  <!--Volver atras -->
   <button type="button" onclick="history.back()" class="btn btn-light bg-white rounded-pill shadow-sm px-4 mb-4"><i class="fas fa-arrow-left"></i><small class="text-uppercase font-weight-bold"></small></button>
  <!-- Toggle button -->
